...
class Check {
    public static int treasures(int id) { return First.lab.player[id].treasures; }
    public static int treasureOut(int id) { return First.lab.player[id].treasuresOut; }
    public static int knifes(int id) { return First.lab.player[id].knifes; }
    public static int armors(int id) { return First.lab.player[id].armors; }

    public static int bullets(int id) { return First.lab.player[id].bullets; }
    public static int crackers(int id) { return First.lab.player[id].crackers; }
}
class Name {
